 ...
 */
enum class AppEnum(val packageName: String) {
    Ins3(packageName = "instagram.video.downloader.story.saver.ig"),
    MediaSaver(packageName = "instagram.video.downloader.story.saver.ig.insaver"),
